...
class First extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Screen("assets/images/Android.jpeg", "second", "ANDROID COURSE"),
          Screen("assets/images/IOS.jpeg", "third", "IOS COURSE"),
          Screen("assets/images/fullStack.jpeg", "third", "FULL STACK")
        ],
      ),
    );
  }
        ...
        child: Stack(
          children: [
            Container(
                ...
                child:
                    Screens("assets/images/Android.jpeg", '''Part 1 ( Java SE)
        ...
        body: SingleChildScrollView(
          child: Stack(children: [
            Container(
                ...
                child: Screens("assets/images/IOS.jpeg", '''
OOP refreshment
• Introduction
        ...
        body: SingleChildScrollView(
          child: Stack(children: [
            Container(
              ...
              child: Screens('assets/images/fullStack.jpeg', '''
•HTML	
•HTML 5 
•CSS
•CSS3
...
class Screen extends StatelessWidget {
  ...
  Screen(this.imagePath, this.button, this.ButtinName);
...
class Screens extends StatelessWidget {
  ...
  Screens(this.Imagee, this.Textt);
